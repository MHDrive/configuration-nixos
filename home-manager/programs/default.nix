    ...
    programs = {
        ...
        bash = {
            ...
            bashrcExtra = ''
                ...
                function show_banner() {
                    ...
                    echo -e "$color_green  → DE: $(echo $XDG_CURRENT_DESKTOP) $(gnome-shell --version | awk '{print $3}')" $color_reset
        ...
        starship = {
            ...
            settings = {
                ...
                add_newline = true;
                format = ''
                    [┌──\[$username[@](bold blue)$hostname\]─>](bold green)$git_branch$git_status
